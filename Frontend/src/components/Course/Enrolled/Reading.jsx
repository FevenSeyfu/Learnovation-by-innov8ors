  ...
  return (
    <div className="py-4 flex flex-col items-start gap-6">
      ...
      <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-400">
        ...
        <li>
          <strong>2. Define:</strong> Clearly articulate the problem you want to
          solve.
        </li>
        <li>
        ...
        <li>
          <strong>4. Prototype:</strong> Build simple, tangible prototypes to
          explore potential solutions.
        </li>
        <li>
          <strong>5. Test:</strong> Test the prototypes with real users to
