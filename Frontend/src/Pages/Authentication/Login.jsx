        ...
        <div className=" h-full w-full bg-white pt-8 rounded-md">
          ...
          <div className="md:px-16 px-8">
            ...
            <div className="flex justify-center">
              <h3 className="text-3xl font-bold mx-auto md:pt-12  bg-gradient-to-r from-textBlue via-fushiaPink to-lightPink inline-block text-transparent bg-clip-text">Login</h3>
            </div>
            ...
            <form className="md:pt-6 pt-3" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end">
                <p className="text-sm font-semibold">Don't have an account? <Link to='/signup'>Signup</Link></p>
              </div>
